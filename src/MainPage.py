...
class MainPage:
    ...
    def MainPage():
        ...
        st.markdown(""" 
            <h1 style="background-color: #112639; border: 1px solid black; color: white; font-family: 'Times New Roman', serif; text-align: center; padding: 9px;">
                Qual-D
            </h1>
        ...
        selected = option_menu(None, ["What's New", "Upload","Filters", "Contact Us"],  
                ...
                styles={
                    ...
                    "nav-link": {"font-size": "16px", "text-align": "center", "margin": "0px", "color": "black", "--hover-color": "rgba(255, 87, 51,0.5)","padding":"3px"},
